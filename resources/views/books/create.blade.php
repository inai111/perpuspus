                    ...
                    <div class="col-lg-10 mb-3">
                        <div class="card rounded shadow">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <img id="imgPreview" class="img-thumbnail" src="" alt="Cover Photo"
                                        ...
                                        <div class="d-flex flex-column h-100">
                                            <form action="{{ route('book.store') }}" method="post"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" @class(['form-control', 'is-invalid' => $errors->has('cover_photo')]) id="cover_photo"
                                                        name="cover_photo">
                                                    @error('cover_photo')
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" @class(['form-control', 'is-invalid' => $errors->has('author')]) id="author"
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" @class(['form-control', 'is-invalid' => $errors->has('publisher')]) id="publisher"
